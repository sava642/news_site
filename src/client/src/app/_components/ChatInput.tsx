...
const ChatInput: React.FC<ChatProps> = ({ message, setMessage, sendMessage }) => {
	...
	return (
		...
		<div id="chat-container" ref={chatContainerRef}>
			<div ref={messageInputRef} className={`flex items-center space-x-2 p-2 w-full ${isFixed ? 'fixed bottom-12 left-0  bg-white  z-10 dark:bg-gray-800 dark:border-gray-700' : ''}`}>
				<input
					type="text"
					value={message}
